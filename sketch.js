...
function draw() {
 ...
 // }
  ...
  function wave1() {
    if (frameCount % 60 === 0) {
     var enemy_ship = createSprite(0,Math.round(random(300, 30)), 10, 10);
  ...
  function wave2() {
    if (frameCount % 60 === 0) {
     var enemy_ship2 = createSprite(0,Math.round(random(150, 30)), 10, 10);
  ...
  function wave3() {
    if (frameCount % 60 === 0) {
     var enemy_ship3 = createSprite(0,Math.round(random(450, 30)), 10, 10);
